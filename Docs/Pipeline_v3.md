...
| ---------- | ------------------- | ------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **A**      | Crawl + Queue       | ECS Fargate, SQS, ECR, Docker                          | Dockerfile cho Fargate Crawler, cấu hình SQS + Dead Letter Queue, deploy Docker image lên ECR, viết Sitemap Spider cho Scrapy crawl 3 báo               |
